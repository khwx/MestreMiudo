 ...
 * 
 * Issue 1: Prisma question - answer "9 arestas" missing from options
 * Issue 2: Weight question - answer "0,375 kg" missing from options
 */

import { createClient } from '@supabase/supabase-js';

const supabaseUrl = process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://ppvftnxrpxxafarttyim.supabase.co';
const supabaseAnonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'sb_publishable_Srbzxo3Q9_K8j0yhs_ePLg_p8uPq9tU';
